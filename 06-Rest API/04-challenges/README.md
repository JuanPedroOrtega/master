...
Implementación de todos los challenges.
...
1. **Búsqueda de personajes** - Campo de búsqueda con debounce
2. **Locations** - Ruta `/locations`
3. **Episodes** - Ruta `/episodes`

## Rutas

- `/characters` - Listado con búsqueda
- `/characters/:id` - Detalle
- `/locations` - Listado de lugares
